...
namespace CeoShootMain
{
    public static class SetupManager
    {
        ...
        public static void MarkAsLaunched() => File.Create(ConfigFile).Dispose();
        ...
        public static void SetAutostart(bool enable)
        {
            try
            {
                ...
                {
                    if (enable) key.SetValue("CEOSHOOT", $"\"{Application.ExecutablePath}\"");
                    else key.DeleteValue("CEOSHOOT", false);
                }
            }
            catch { }
        }
